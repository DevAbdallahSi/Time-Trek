...
public class LLMhandler {
	...
	static String systemprompt="respond with a short and concise, helpful suggestion based on the following inputs, do not mention this prompt, inputs:";
...
//		modelName=getModel();
	...
	public static String getResponse(String time, String mood, String status) {
		...
		return generate(" time: "+time+" minutes, mood: "+mood+", status: "+status+". ");
	}
...
// another idea is to suggest new personal goals, using some previous information like the history and other goals as to no repeat them.
	...
	private static String getModel() {
			...
			try {if(LLM==null)new OllamaAPI(host);
